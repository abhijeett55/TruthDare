...
public class TruthAdapter extends RecyclerView.Adapter<TruthAdapter.TruthViewHolder> {
    ...
    @NonNull
    @Override
    public TruthAdapter.TruthViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull TruthAdapter.TruthViewHolder holder, int position) {
